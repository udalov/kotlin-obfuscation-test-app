package tests.typeOf.nonReifiedTypeParameters.simplePropertyParameter
...
fun box(): String {
    val fqn = className("tests.typeOf.nonReifiedTypeParameters.simplePropertyParameter.Container")
